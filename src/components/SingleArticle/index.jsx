      ...
      <div className="row h-full">
        <div className="col-12 col-lg-8 offset-lg-2 align-self-center">
          ...
          <p>
            ...
            <a className="text-white" href="https://google.com/">Hossein Shams</a>
          </p>
          <p>
        ...
        <div className="col-12 align-self-end text-center">
          <a className="scroll-down-1 scroll-down-inverse" href="https://google.com/" data-scrollto="section-content">
            <span />
          </a>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-12 col-lg-8 offset-lg-2">
            ...
            <div className="gap-multiline-items-1 mt-30">
              <a className="badge badge-pill badge-default" href="https://google.com/">Record</a>
              <a className="badge badge-pill badge-default" href="https://google.com/">Progress</a>
              <a className="badge badge-pill badge-default" href="https://google.com/">Customers</a>
              <a className="badge badge-pill badge-default" href="https://google.com/">News</a>
            </div>
          </div>
        </div>
      </div>
